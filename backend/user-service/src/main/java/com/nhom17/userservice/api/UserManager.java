...
import com.nhom17.userservice.exception.wrapper.TokenErrorOrAccessTimeOut;
import com.nhom17.userservice.exception.wrapper.UserNotFoundException;
import com.nhom17.userservice.http.HeaderGenerator;
import com.nhom17.userservice.model.dto.request.ChangePasswordRequest;
import com.nhom17.userservice.model.dto.request.SignUp;
import com.nhom17.userservice.model.dto.request.UserDto;
import com.nhom17.userservice.model.dto.response.ResponseMessage;
...
public class UserManager {
    ...
    @Operation(
        ...
        description = "Update the user information with the provided details."
    )
    @ApiResponses(value = {
    ...
    @Operation(
        summary = "Get a secure user resource",
